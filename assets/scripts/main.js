$(function() {
    ...
    var initDemo = function() {
        ...
        var stories = new Zuck('stories', {
            ...
            stories: [{
                id: "johndoe",
                photo: "/assets/images/avatar/portrait.jpg",
                name: "STORIES",
                link: "",
                lastUpdated: 1505845276,
                items: [
                    // --- Commented By Me ---
                    // buildItem("johndoe-1", "photo", 5, "/assets/images/avatar/portfolio5.jpeg", "/assets/images/avatar/portfolio5.jpeg", '', false, 1505845276),
                    // buildItem("johndoe-2", "video", 0, "images/storyvideo.mp4", "images/storyvideo.mp4", '', false, 1505845276),
                    // buildItem("johndoe-3", "photo", 3, "/assets/images/avatar/portrait.jpg", "/assets/images/avatar/portrait.jpg", '', false, 1505845276),
                ]
            }]
        });
